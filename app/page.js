  ...
  return (
    <>
      <section style={{ height: '90vh', position: 'relative', margin: '0', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <article>
          <Image className='rotation-animation'
        ...
        <article style={{ position: 'relative', marginLeft: '50px', maxWidth: '800px' }}>
          <h1 style={{ marginBottom: '10px' }} variant='h1'>Unleash Your Dueling Potential with Yu-Gi-Oh Meta!</h1>
          <p style={{ marginBottom: '20px' }}>Your Source for Current Tournament Statistics and Insights. Elevate Your Dueling Game with In-Depth Analysis and Winning Strategies.</p>
